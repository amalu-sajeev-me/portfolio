...
export default function NewBlogPostPage() {
  ...
  if (!user) {
    return (
      <SectionWrapper id="new-post" className="text-center">
        <div className="min-h-[60vh] flex flex-col items-center justify-center">
          <h1 className="section-title text-3xl md:text-4xl mb-4">Sign In Required</h1>
          <p className="text-muted-foreground mb-8">Sign in to create blog posts.</p>
          <motion.button
    ...
    return (
      <SectionWrapper id="new-post" className="text-center">
        <div className="min-h-[60vh] flex flex-col items-center justify-center">
          ...
          <p className="text-muted-foreground mb-8">You don&apos;t have permission to create posts.</p>
    ...
    <SectionWrapper id="new-post">
      <div className="min-h-screen py-8 max-w-4xl mx-auto">
        ...
        <h1 className="section-title text-3xl md:text-4xl mb-8">
          Create New <span className="gradient-text">Post</span>
        </h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex justify-end gap-4 pt-4">
              ...
              >
                ...
                <span className="font-medium">{published ? "Publish" : "Save Draft"}</span>
              </motion.button>
            </div>
          </form>
        )}
